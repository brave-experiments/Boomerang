...
impl<P: PedersenConfig> PolynomialInterpolation<P> {
    ...
    fn evaluate_polynomial(coeff: &[<P as CurveConfig>::ScalarField],
                               x: &<P as CurveConfig>::ScalarField) -> <P as CurveConfig>::ScalarField {
    ...
    pub fn interpolate(x: &[<P as CurveConfig>::ScalarField],
                       y: &[<P as CurveConfig>::ScalarField]) -> Vec<<P as CurveConfig>::ScalarField> {
